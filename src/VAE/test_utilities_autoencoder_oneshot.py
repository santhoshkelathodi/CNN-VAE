...
def read_data_sets_images(train_dir,
  ...
  train_images = X_train_images[:] # changed for test code
  train_labels = labels_train_images_onehot[:] ## changed for test code


  options = dict(dtype=dtype, reshape=reshape, seed=seed)

  train = DataSet(train_images, train_labels, **options)# only for test
  validation = DataSet(train_images, train_labels, **options)# only for test
  test = DataSet(train_images, train_labels, **options)# only for test Only this gets used

  return base.Datasets(train=train, validation=validation, test=test), labels_train_images, ids
